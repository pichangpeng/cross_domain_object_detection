# python3 main/fasterRcnn_test.py --batchSize 3  --imagesRoot data/images/test/night --labelsRoot data/labels/test/night.json --fasterRcnn_weight output/weight/fasterRcnn.pth
